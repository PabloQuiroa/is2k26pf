...
namespace Interfac_V3
{
    public partial class FormModulos : Form
    {
        ...
        {
            Frm_Login logn = new Frm_Login(); //FormPrincipal forma = new FormPrincipal();
            logn.Show();//forma.Show();
        }
        ...
        {
            Frm_LOGIN loginlogistica = new Frm_LOGIN();//FormPrincipal forma = new FormPrincipal();
            loginlogistica.Show();//.Show();
        }
    }
}
